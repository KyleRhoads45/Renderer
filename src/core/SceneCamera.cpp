...
void SceneCamera::Update() {
    ...
    m_Rotation = pitchRot * yawRot;

    const glm::vec3 forward = glm::normalize(glm::rotate(glm::inverse(m_Rotation), glm::vec3(0.0f, 0.0f, -1.0f)));
    const glm::vec3 right = glm::normalize(glm::rotate(glm::inverse(m_Rotation), glm::vec3(1.0f, 0.0f, 0.0f)));
